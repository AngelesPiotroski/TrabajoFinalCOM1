    ...
    <body>
        ...
        <div class="limiter">
            <div class="container-table100">
                ...
                %>
                <H3  >Lista de todas las Reservas realizadas por el Empleado: <%=nombreEmpleado%></H3>
                <div class="wrap-table100">
                    <div class="table">     
                        ...
                        <%for (Reserva resEmp : emp.getReservas()) {%>
                        <div class="row">
                            <% String fechaCreacion = control.convertirDateToString(resEmp.getFechaCreacion());%>
                            <div class="cell" data-title="Fecha de Creacion">
                                <%=fechaCreacion%>
                            </div>

                            <% String checkin = control.convertirDateToString(resEmp.getCheckIn());%>
                            <div class="cell" data-title="Check in">
                                <%=checkin%>
                            </div>

                            <% String checkout = control.convertirDateToString(resEmp.getCheckOut());%>
                            <div class="cell" data-title="Check out">
                                <%=checkout%>
                            </div>

                            <% String nombreHabi = resEmp.getHabitacion().getTipo().getNombre();%>
                            <div class="cell" data-title="Habitacion">
                                <%=nombreHabi%>
                            </div>
                            <% String nombreHues = resEmp.getHuesped().getApellido()+" "+ resEmp.getHuesped().getNombre();%>
