    ...
    <body>
        ...
        <div class="limiter">
            <div class="container-table100">
                <h3  >Lista de todas las Habitaciones del sistema </h3>
                <div class="wrap-table100">
                    <div class="table">
                        ...
                        <%
                            ...
                            List<Habitacion> listaHab = control.listaHabitaciones();
                        ...
                        <div class="row">
                            ...
                            <div class="cell" data-title="Piso">
                                <% String piso = String.valueOf(hab.getPiso());%>
                                <%=piso%>
                            </div>
                            <div class="cell" data-title="Precio Noche">
                                <% String precio = String.valueOf(hab.getPrecioNoche());%>
                                <%=precio%>
                            </div>
                            <div class="cell" data-title="Tipo Habitacion">
                                <%=hab.getTipo().getNombre()%>
                            </div>

                            <%int id = hab.getNroHabitacion();%>
